...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        index page."""
        question = self.create_question(question_text="Past question.",
                                        days=-30)
        response = self.client.get(reverse('polls:index'))
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        future_question = self.create_question(question_text='Future question.',
                                               days=5)
    ...
    def test_past_question(self):
        ...
        past_question = self.create_question(question_text='Past question.',
                                             days=-5)
